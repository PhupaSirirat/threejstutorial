...
const spaceTexture = new THREE.TextureLoader().load('pexels-hristo-fidanov-1252890.jpg')
...
// Moon
const moonTexture = new THREE.TextureLoader().load('b.jpg');
...
// automaticaly add scene (similar to gameloop)
function animate() {
